...
INSERT INTO tb_atividade(name, descricao, price, categoria_id) VALUES('Curso de HTML', 'Aprenda HTML de forma prática', 80.0, 1);
INSERT INTO tb_atividade(name, descricao, price, categoria_id) VALUES('Oficina de GitHub', 'Controle versões de seus projetos', 50.0, 2);
